...
var submit = document.getElementById('submit'); //Кнопка инициализации поля
...
canvas.onclick = function (e) {
    var i = Math.floor(e.offsetX / canvas_dot);
    var j = Math.floor(e.offsetY / canvas_dot);
